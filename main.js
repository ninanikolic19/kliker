$(document).ready(function() {
    ...
    let nizLokacija = [
        ["Beograd", "U srcu Beograda nalaze se naše učionice, dizajnirane da budu savršeno mesto za učenje predškolaca, osnovaca i srednjoškolaca. " +
        ...
        "naše učionice u Beogradu su mesto gde svaka ideja može postati stvarnost.", ["bg1.webp", "bg2.webp", "bg3.webp"]],

        ["Novi Sad", "Naše učionice u Novom Sadu predstavljaju savršeno mesto za učenje i razvoj predškolaca, osnovaca i srednjoškolaca. " +
        ...
        "stvaraju i razvijaju svoje potencijale", ["ns1.jpeg", "ns2.webp", "ns3.jpeg"]],

        ["Niš", "Naše učionice u Nišu su sinonim za savremeni prostor za učenje, osmišljen tako da deci svih uzrasta pruža inspirativno i podsticajno okruženje. " +
        ...
        "omogućavajući deci da kroz inovativan pristup učenju savladaju nove veštine.", ["nis1.webp", "nis2.jpeg", "nis3.webp"]]
    ];


    let najmladji = [
        ["Programiranje za predškolce", "Kurs osnova programiranja sa Bee Bot-om namenjen deci predškolskog uzrasta.", "5 - 6 godina", "predskolci-370x290-1.jpg"],
        ["Početno programiranje", "Upoznavanje principa kompjuterske nauke i programiranja.", "6 - 7 godina", "POCETNO-PROGRAMIRANJE-370x290-1.png"],
        ["Scratch Start", "Programiranje kroz pravljenje igrica i animacija na Scratch platformi.", "5 - 7 godina", "Scratch-Start-Feature-Image-1024x683px-370x290-1.png"],
    ];

    let osnovci = [
        ["Scratch 1", "Programiranje kroz pravljenje igrica i animacija na Scratch platformi.", "III - V razred", "scr-370x290-1.png"],
        ["Scratch 2", "Programiranje kroz pravljenje igrica i animacija na Scratch platformi. ", "V - VII razred", "s2-370x290-1.png"],
        ["Elektronika", "Od sijalice do robota – elektronika i programiranje Arduina.", "V - VII razred", "Elektronika_Feature-image-logo-370x290-1.png"],
        ["Robotika 1", "Programiranje robota i njegovih funkcija. Uvod u robotiku.", "III - V razred", "rob-370x290-1.png"],
        ["Robotika 2", "Nastavak Robotika 1 kursa – prelaz sa blokovskog na pisano kodiranje.", "IV - VII razred", "robotika-2-kurs-370x290-1.png"],
        ["3D štampa i modelovanje", "Uz pomoć 3D olovke i 3D štampača otkrivamo jedan predivan svet.", "III - VI razred", "3d-370x290-1.png"]
    ];

    let srednjoskolci = [
        ["Web programiranje", "Učimo da napravimo prvi veb-sajt na zabavan način.", "srednja škola", "wp1-370x290-1.png"],
        ["C# programiranje", "Uvod u objektno orijentisano programiranje aplikacija za PC.", "srednja škola", "C-370x290-1.png"],
        ["JavaScript", "JavaScript programiranje – kreiranje dinamičnih veb-stranica (aplikacija).", "srednja škola", "JavaScript_Feature-Image_1024x683px-1-370x290-1.png"],
    ];
...
function ispisNovosti() {
    ...
    let nizNovosti = [
        ["VEST", "blog4.webp", "Tim", "Emocionalna inteligencija", "Sigurno ste čuli za mnogobrojne prednosti učenja programiranja za decu. Ali, da li znate da programiranje može pomoći vašem detetu da razvije i emocionalnu inteligenciju?"],
        ["EDUKACIJA", "blog3.jpg", "Mit", "Mitovi o programiranju za decu", "Pogledajmo neke od najčešćih mitova i razbijmo ih, otkrivši pritom kako programiranje može biti zabavno i korisno za svako dete."],
        ["EDUKACIJA", "blog2.jpg", "Svet", "5 razloga zašto vaše dete treba da uči programiranje", "Živimo u digitalnom dobu, u kom tehnologija oblikuje naš svakodnevni život.Jedna od najvažnijih veština koju vaše dete može da nauči jeste programiranje."],
        ["VEST", "blog5.webp", "Razvoj", "Kako programiranje razvija kreativnost kod dece", "Programiranje nije samo tehnička veština – ono otvara vrata za razvoj kreativnosti, logičkog razmišljanja i sposobnosti rešavanja problema."],
        ["EDUKACIJA", "blog6.webp", "Budućnost", "Zašto je programiranje ključno za budućnost", "U svetu koji se sve više oslanja na tehnologiju, programiranje postaje osnovna veština koja može otvoriti vrata ka brojnim zanimljivim i dinamičnim karijerama."],
        ["ZANIMLJIVOST", "blog7.webp", "Igra", "Kako se deca mogu igrati dok uče programiranje", "Kroz kreativne igre i projekte, deca mogu naučiti osnove programiranja na zabavan i interaktivan način, razvijajući ljubav prema učenju."]
    ];
...
function ispisDizajnera() {
    ...
    for (let i = 0; i < nizProfesora.length; i++) {
        profesoriElement.innerHTML += `
        <div class="card col-xs-6 text-center col-8 col-sm-6 col-md-3 brd-none">
...
function ispisForme() {
    ...
    for (let i = 0; i < nizPrograma.length; i++) {
        for (let j = 0; j < nizPrograma[i].length; j++) {
            programiElement.innerHTML += `<option value="${i+j}">${nizPrograma[i][j][0]}</option>`
        }
    }
}
